  ...
  return (
    <div className="mx-auto space-y-6 flex flex-col justify-center items-center">
        <div className="text-center space-y-5">
         <h2 className="text-3xl font-bold md:text-5xl bg-linear-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Meet Our Top Specialists</h2>  
      ...
      <div className="mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
        {doctors.map((doctor, index) => (
          <motion.div
            key={doctor._id}
            initial={{ opacity: 0, x: 100 }}   // 👉 RIGHT → LEFT
